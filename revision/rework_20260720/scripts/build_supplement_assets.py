...
def build_tabular_assets() -> None:
    ...
    external = pd.DataFrame([
        ...
        ("All frozen candidates", "New wet-lab viability/biochemical assay", "Not performed; the reviewer suggested either wet-lab assays or public transcriptomic validation", "Official-condition measured LINCS used as the public transcriptomic option", "Does not replace viability or biochemical validation"),
