...
Only Mocetinostat and PCI-24781 satisfy strict leave-drug candidate membership. For PCI-24781, the seed-paired 95\% interval favored the fingerprint baseline for profile correlations; no strict candidate result favored the dual stream. These three-seed intervals are uncertainty summaries rather than population-level significance tests.
