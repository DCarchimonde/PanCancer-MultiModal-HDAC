...
const specs = [
  ...
  ["24_PredMeasured_Plot", "results/revision/measured_lincs_figures/predicted_measured_hiq_plot_data.csv", "Candidate-cancer plot data for corrected-HDAC predicted--measured HiQ concordance."],
  ["25_PredMeasured_Seed", "results/revision/measured_lincs_figures/predicted_measured_hiq_correlations_by_seed.csv", "Predicted--measured concordance by model seed."],
...
const dictionaryRows = [
  ...
  ["signed wTRS", "Negative disease--perturbation dot product normalized by disease absolute magnitude; higher means stronger opposition and the value is linear in perturbation amplitude."],
  ["Spearman reversal", "Negative Spearman disease--perturbation correlation; higher means stronger rank opposition and the value is invariant to positive rescaling."],
  ...
  ["Predicted--measured concordance", "Association between model-derived and measured reversal for the eight evaluated compounds; not preferential validation without a condition-matched comparator set."],
  ["Portable reproducibility", "Reported values are auditable and documents recompilable from frozen assets; not every upstream computation can be rerun bitwise from Git alone."],
];
...
const readmeRows = [
  ["File", "Additional file 2: Machine-readable revised-analysis tables"],
  ["Manuscript", "A Leakage-Aware and Auditable Framework Prioritizes Class I HDAC Inhibitors for Pan-Cancer Transcriptomic Reversal"],
  ...
  ["Primary model conclusion", "No measurable dual-stream gain; the strong conventional fingerprint MLP comparator is at least as predictive and more efficient."],
  ["Candidate hierarchy", "Mocetinostat core; NCH-51 secondary; TC-H-106 exploratory."],
  ["Measured evidence", "Predicted--measured LINCS concordance for eight compounds; no condition-matched non-HDAC comparator and no preferential validation claim."],
  ["Class enrichment", "Signed wTRS significant; Spearman reversal not significant. Signed wTRS is amplitude-sensitive, so response magnitude may contribute."],
  ...
  ["Reproducibility boundary", "Reported values can be audited and documents recompiled from frozen assets. A bitwise end-to-end rerun from GitHub and current public inputs alone is not guaranteed; see REPRODUCIBILITY.md."],
];
