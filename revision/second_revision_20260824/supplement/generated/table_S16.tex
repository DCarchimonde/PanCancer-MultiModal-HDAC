...
\caption{Formal HDAC enrichment at fixed revision library cutoffs. Consensus ranks equally average 24 screening runs across 22 cancers per compound as mean rank fractions (0 = strongest); Fisher tests are one-sided and FDR is within each metric and annotation definition.}\label{tab:s_enrichment}\\
\toprule
