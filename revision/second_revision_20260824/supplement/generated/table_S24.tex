...
\begin{table}[H]
\centering
\caption{Reproducibility inventory. Unrecorded CPU/RAM values are disclosed rather than guessed.}
\label{tab:s_repro}
\begin{tabular}{@{}p{0.22\textwidth}p{0.43\textwidth}p{0.30\textwidth}@{}}
\toprule
