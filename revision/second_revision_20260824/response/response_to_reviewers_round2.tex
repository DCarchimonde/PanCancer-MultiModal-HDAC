...
\item Added a running title and a standard ``List of additional files,'' and clarified that the matching Mocetinostat and PCI-24781 profile counts in the strict leave-drug and corrected-HDAC tests arise because both splits hold out each complete canonical structure, not because the overall test partitions are the same.
\end{enumerate}
...
\Location Clean revised manuscript: title page; Abstract (pp.~1--2, lines 15--60); Background (pp.~2--4, lines 63--114); Methods subsection ``Statistical analysis, reproducibility, and reporting'' (p.~13, lines 344--359); Discussion and Limitations (pp.~27--31, lines 547--655); and Conclusions (pp.~31--32, lines 656--668).

\noindent\textbf{Additional locations:} Availability statement (p.~33, lines 686--706); ``List of additional files'' (pp.~34--35, lines 728--738); and repository files \texttt{README.md} and \texttt{REPRODUCIBILITY.md}.
...
\Location Clean revised manuscript: title page; Abstract (pp.~1--2, lines 15--60); Background representation and contribution paragraphs (pp.~3--4, lines 78--114); Results subsection ``Repeated generalization benchmarks show no measurable dual-stream gain'' (pp.~15--16, lines 394--415); opening Discussion paragraphs (pp.~27--29, lines 547--571); and Conclusions (pp.~31--32, lines 656--668). References added at pp.~38--39, lines 828--838: Deng et al. (2023), Delre et al. (2022), and Delre et al. (2023; ALPACA).
...
\Action We now restrict the enrichment claim to signed wTRS in the title-independent central narrative, Abstract, Methods, Results subsection heading and text, figure interpretation, Discussion, Limitations, Conclusions, Supplement, repository README, and workbook README/Data Dictionary. The Limitations explicitly states that a magnitude-controlled sensitivity analysis was considered but not added post hoc because no unique adjustment had been prespecified and choosing among alternative schemes after observing the divergence would introduce an unplanned analytic choice. This follows the reviewer's explicitly acceptable qualification route.
...
\Location Clean revised manuscript: Abstract Results (pp.~1--2, lines 34--54); Methods subsection ``Pan-cancer screening and transcriptomic reversal metrics'' (pp.~9--10, lines 233--266); Results subsection ``Pan-cancer screening shows signed-wTRS-specific class I HDAC enrichment'' (p.~14, lines 379--393); class-level Discussion paragraph (pp.~29--30, lines 591--602); Limitations (pp.~30--31, lines 624--647); and Conclusions (pp.~31--32, lines 656--668). Additional file 1: section ``Candidate stability, structural exposure, and formal class enrichment.''
...
\Location Clean revised manuscript: Methods subsection ``Official-condition measured LINCS comparison'' (pp.~10--11, lines 267--290); Results subsection ``Predicted and measured LINCS reversal are concordant for both encoders'' (pp.~18--19, lines 451--465) and Figure~3 caption (p.~20); Discussion (p.~29, lines 572--581); Limitations (pp.~30--31, lines 624--647); and Conclusions (pp.~31--32, lines 656--668). Additional file 1: section ``Measured LINCS reversal and prediction--measurement concordance.''
...
\Location Clean revised manuscript: Abstract Methods and Results (pp.~1--2, lines 22--54); Background representation and contribution paragraphs (pp.~3--4, lines 78--114); Methods subsection ``Molecular representations and prediction models'' (pp.~6--7, lines 168--204); Results model-comparison subsection (pp.~15--16, lines 394--415); Discussion (pp.~27--29, lines 547--571); and Conclusions (pp.~31--32, lines 656--668). Additional file 1: model-evaluation text and strict leave-drug interpretation.
...
\Location Clean revised manuscript: Abstract Results, first sentence (p.~1, lines 34--35).
...
\Location Clean revised manuscript: Conclusions, opening two sentences (pp.~31--32, lines 657--661).
